...
function Button({ children, disabled, onClick, to, type }) {
  ...
  const styles = {
    ...
    secondary:
      ' inline-block text-sm rounded-full border-2  border-stone-00 font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:text-white-800 hover:bg-red-800 focus:text-stone-700 focus:bg-red-300 focus:outline-none focus:ring focus:ring-red-200 focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2.5 md:px-6 md:py-3.5 ',
  };
  if (to)
    return (
